...
// bg-gradient-to-r from-[#8B0000] to-[#FF0000] butttons for shake and skip

// bg-gradient-to-r from-[#00b4db] to-[#0083b0] bgCards

// from-[#6d6027] to-[#ae8902] put in circle button